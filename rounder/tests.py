...
def main():
	...
	try:  # Test 1
		...
		print('Rounder test 1 failed with error:', e)
		failed += 1

	if test_1a == 5 and test_1b == 4 and type(test_1a).__name__ == 'int' and type(test_1b).__name__ == 'int':
		print('Rounder test 1 passed')
	else:
		print('Rounder test 1 failed:', test_1a, test_1b)
		failed += 1
	...
	try:  # Test 2
		...
		print('Rounder test 2 failed with error:', e)
		failed += 1

	if test_2a == 3.456 and test_2b == 3.457 and type(test_2a).__name__ == 'float' and type(test_2b).__name__ == 'float':
		print('Rounder test 2 passed')
	else:
		print('Rounder test 2 failed:', test_2a, test_2b)
		failed += 1
	...
	try:  # Test 3
		...
		print('Rounder test 3 failed with error:', e)
		failed += 1

	if test_3a == 3.5 and test_3b == 3.4 and type(test_3a).__name__ == 'float' and type(test_3b).__name__ == 'float':
		print('Rounder test 3 passed')
	else:
		print('Rounder test 3 failed:', test_3a, test_3b)
		failed += 1
	...
	try:  # Test 4
		...
		print('Rounder test 4 failed with error:', e)
		failed += 1
	...
	if test_4a == 'not inappropriate' and test_4b == test_4b_error and type(test_4a).__name__ == 'str' and type(test_4b).__name__ == 'str':
		print('Rounder test 4 passed')
	else:
		print('Rounder test 4 failed:', test_4a, test_4b)
		failed += 1
	...
	print('Rounder test 5 passed with times:')
	...
	try:  # test 6
		...
		print('Rounder test 6 failed with error:', e)
		failed += 1

	if test_6a == 4 and test_6b == 4 and type(test_6a).__name__ == 'int' and type(test_6b).__name__ == 'int':
		print('Rounder test 6 passed')
	else:
		print('Rounder test 6 failed:', test_6a, test_6b)
		failed += 1
	...
	try:  # Test 7
		...
		print('Rounder test 7 failed with error:', e)
		failed += 1

	if test_7a == 2 and test_7b == 3 and type(test_7a).__name__ == 'int' and type(test_7b).__name__ == 'int':
		print('Rounder test 7 passed')
	else:
		print('Rounder test 7 failed:', test_7a, test_7b)
		failed += 1
	...
	try:  # Test 8
		...
		print('Rounder test 8 failed with error:', e)
		failed += 1

	if test_8a == -4 and test_8b == -3 and type(test_8a).__name__ == 'int' and type(test_8b).__name__ == 'int':
		print('Rounder test 8 passed')
	else:
		print('Rounder test 8 failed:', test_8a, test_8b)
		failed += 1
	...
	try:  # Test 9
		...
		print('Rounder test 9 failed with error:', e)
		failed += 1

	if test_9a == 3.123 and test_9b == None and type(test_9a).__name__ == 'float':
		print('Rounder test 9 passed')
	else:
		print('Rounder test 9 failed:', test_9a, test_9b)
	...
	try:  # Test 10
		...
		print('Rounder test 10 passed')
	except Exception as e:
		print('Rounder test 10 failed with error:', e)
		failed += 1
	...
	try:  # Test 11
		...
		print('Rounder test 11 failed with error:', e)
		failed += 1

	if test_11a == -4 and test_11b == -4 and type(test_11a).__name__ == 'int' and type(test_11b).__name__ == 'int':
		print('Rounder test 11 passed')
	else:
		print('Rounder test 11 failed:', test_11a, test_11b)
		failed += 1
	...
	try:  # Test 12
		...
		print('Rounder test 12 failed with error:', e)
		failed += 1

	if test_12a == 4.11231 and test_12b == 4.1933012 and type(test_12a).__name__ == 'float' and type(test_12b).__name__ == 'float':
		print('Rounder test 12 passed')
	else:
		print('Rounder test 12 failed:', test_12a, test_12b)
		failed += 1
	...
	try:  # Test 13
		...
		print('Rounder test 13 failed with error:', e)
		failed += 1

	if test_13a == 341 and test_13b == 342 and type(test_13a).__name__ == 'int' and type(test_13b).__name__ == 'int':
		print('Rounder test 13 passed')
	else:
		print('Rounder test 13 failed:', test_13a, test_13b)
		failed += 1
	...
	try:  # Test 14
		...
		print('Rounder test 14 failed with error:', e)
		failed += 1

	if test_14a == 342 and test_14b == 0 and type(test_14a).__name__ == 'int' and type(test_14b).__name__ == 'int':
		print('Rounder test 14 passed')
	else:
		print('Rounder test 14 failed:', test_14a, test_14b)
		failed += 1
	...
	try:  # Test 15
		...
		print('Rounder test 15 failed with error:', e)
		failed += 1
